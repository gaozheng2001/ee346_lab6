...
class Follower:
    ...
    def __init__(self):
        ...
        self.image_sub = rospy.Subscriber('camera/image_compensated',
                                          Image, self.image_callback)

        self.image_project_sub = rospy.Subscriber('camera/image_projected_compensated',
                                          Image, self.image_project_callback)
    ...
    def image_callback(self, msg):
        ...
        upper_yellow = numpy.array([0, 0, 90])

        lower_white = numpy.array([0, 0, 0])
        upper_white = numpy.array([0, 0, 90])
        ...
        if M1['m00'] > 0:
            ...
            # cv2.circle(image_homography, (hfpt_x, hfpt_y),
            #           10, (128, 128, 128), -1)
            ...
            #self.twist.angular.z = (err*90.0/160)/5
            #self.cmd_vel_pub.publish(self.twist)
    ...
    def image_project_callback(self, msg):
        desired_aruco_dictionary = "DICT_6X6_1000"
        # The different ArUco dictionaries built into the OpenCV library.
        ARUCO_DICT = {
            "DICT_4X4_50": cv2.aruco.DICT_4X4_50,
...
(33, 229, '\n', 279, 229, '\n', 131, 144, '\n', 186, 145)
        ...
        # mask2[0:h, 0:search_line] = 0
        cv2.imshow('pmask1', mask1)
        cv2.waitKey(1)
        cv2.imshow('pmask2', mask2)
        cv2.waitKey(1)
