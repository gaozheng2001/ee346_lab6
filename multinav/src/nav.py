...
class MultiNav():
    def __init__(self):
        ...
        locations['1'] = Pose(Point(4.70, 3.7, 0.00),
                              Quaternion(0.000, 0.000, 0.000, 1.000))
        locations['2'] = Pose(Point(0.586, 3.87, 0.00),
                              Quaternion(0.000, 0.000, 0.000, 1.000))
        locations['3'] = Pose(Point(0.377, -0.0768, 0.00),
                              Quaternion(0.000, 0.000, 0.000, 1.000))
        locations['4'] = Pose(Point(4.41, -0.349, 0.00),
                              Quaternion(0.000, 0.000, 0.000, 1.000))
